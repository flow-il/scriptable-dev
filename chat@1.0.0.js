(function () {
  ...
  style.textContent = `
    ...
    #cp-toggle { width: 56px; height: 56px; border-radius: 50%; background: #0084ff; color: #fff; border: none; font-size: 24px; cursor: pointer; box-shadow: 0 4px 16px rgba(0,132,255,.4); transition: transform .2s; }
    ...
    #cp-header { background: #0084ff; color: #fff; padding: 14px 16px; font-weight: 600; font-size: 15px; display: flex; justify-content: space-between; align-items: center; }
    #cp-close { background: none; border: none; color: #fff; font-size: 20px; cursor: pointer; line-height: 1; padding: 0; }
    ...
    .cp-msg--business { background: #0084ff; color: #fff; align-self: flex-start; border-radius: 16px 16px 16px 4px; }
    ...
    #cp-send { padding: 9px 16px; background: #0084ff; color: #fff; border: none; border-radius: 24px; cursor: pointer; font-size: 14px; }
